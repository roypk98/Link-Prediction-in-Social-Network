...
def lhn_index(G,feat,ledge):
    feat['LHN_Index']=0.0
    for i in feat.index.values:
            feat['LHN_Index'][i]=feat['C_Neighbour'][i]/feat['P_Attachment'][i]
...
lhn_index(G_ff, ff_feat, ff_ledge)
...
lhn_index(G_fs, fs_feat, fs_ledge)
